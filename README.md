...
Madhu-Siri is a production-style Android application built with Kotlin, Jetpack Compose, Firebase, and Google Maps to help farmers and beekeepers coordinate spray safety inside a 2 km radius.
